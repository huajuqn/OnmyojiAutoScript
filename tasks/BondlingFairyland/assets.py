...
class BondlingFairylandAssets: 
	...
	# 点击式神录 
	I_BF_RECORDS = RuleImage(roi_front=(1040,567,31,34), roi_back=(1034,563,43,42), threshold=0.8, method="Template matching", file="./tasks/BondlingFairyland/bf/bf_bf_records.png")
	# 镇墓兽 
